...
import com.linagora.calendar.restapi.routes.BookingLinkRequestAcknowledgementNotifier;
...
import com.linagora.calendar.restapi.routes.PublicAgendaDeclineNotifier;
...
public class RestApiModule extends AbstractModule {
    public static final Logger LOGGER = LoggerFactory.getLogger(RestApiModule.class);
    ...
    protected void configure() {
        ...
        routes.addBinding().to(BookedEventCancelRoute.class);
        routes.addBinding().to(BookedEventGetRoute.class);
        ...
        bind(PublicAgendaDeclineNotifier.class).in(Scopes.SINGLETON);
