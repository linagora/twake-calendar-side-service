...
public class HtmlEmailInviteRenderTest {
    ...
    @Test
    void renderEventInviteShouldSucceed() throws Exception {
        File templateDirectory = fileSystem.getFile("classpath://templates/email/event.invite");
        ...
        Map<String, Object> model = ImmutableMap.of(
            "content", ImmutableMap.builder()
                .put("event", ImmutableMap.builder()
                    ...
                    .build())
                .put("inviteMessage", "invites you to a meeting.")
    ...
    @Test
    void renderAllDayEventShouldIncludeAllDayLabel() throws Exception {
        File templateDirectory = fileSystem.getFile("classpath://templates/email/event.invite");
        HtmlBodyRenderer htmlBodyRenderer = HtmlBodyRenderer.forPath(templateDirectory.getAbsolutePath());
        I18NTranslator.PropertiesI18NTranslator.Factory i18nFactory = new I18NTranslator.PropertiesI18NTranslator.Factory(fileSystem.getFile("classpath://"));
    ...
    @Test
    void renderWithValidLocationURLShouldGenerateHyperlink() throws Exception {
        File templateDirectory = fileSystem.getFile("classpath://templates/email/event.invite");
        HtmlBodyRenderer htmlBodyRenderer = HtmlBodyRenderer.forPath(templateDirectory.getAbsolutePath());
        I18NTranslator.PropertiesI18NTranslator.Factory i18nFactory = new I18NTranslator.PropertiesI18NTranslator.Factory(fileSystem.getFile("classpath://"));
        ...
        Map<String, Object> model = ImmutableMap.of(
            "content", ImmutableMap.builder()
                .put("event", ImmutableMap.builder()
                    ...
                    .put("location", "https://meet.example.com/room")
                    .put("isLocationAValidURL", true)
                    .put("isLocationAnAbsoluteURL", true)
                    .put("hasResources", false)
                    .build())
                .put("inviteMessage", "invites you.")
                .build(),
    ...
    @Test
    void renderCancelEventShouldNotShowParticipationButtons() throws Exception {
        File templateDirectory = fileSystem.getFile("classpath://templates/email/event.invite");
        HtmlBodyRenderer htmlBodyRenderer = HtmlBodyRenderer.forPath(templateDirectory.getAbsolutePath());
        I18NTranslator.PropertiesI18NTranslator.Factory i18nFactory = new I18NTranslator.PropertiesI18NTranslator.Factory(fileSystem.getFile("classpath://"));
        ...
        Map<String, Object> model = ImmutableMap.of(
            "content", ImmutableMap.builder()
                .put("event", ImmutableMap.builder()
                    ...
                    .put("summary", "Cancelled Meeting")
                    .put("allDay", false)
                    .put("start", ImmutableMap.of("date", "2025-07-04", "fullDateTime", "2025-07-04 09:00", "time", "09:00", "timezone", "UTC"))
                    .put("end", ImmutableMap.of("date", "2025-07-04", "fullDateTime", "2025-07-04 10:00", "time", "10:00"))
                    .put("location", "Conference Room")
                    .put("isLocationAValidURL", false)
                    .put("isLocationAnAbsoluteURL", false)
                    .put("hasResources", false)
                    .build())
                .put("inviteMessage", "has cancelled the meeting.")
                .put("method", "CANCEL")
                .build(),
            "translate", i18nFactory.forLocale(Locale.ENGLISH)
        );
                ...
                td(width='600px')
                  table(align='center' border='0' cellpadding='0' cellspacing='0' style='width:600px;' width='600')
                    tr
                      td(style='line-height:0px;font-size:0px;mso-line-height-rule:exactly;')--><div style="margin:0px auto;max-width:600px;"><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;"><tbody><tr><td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0;padding-top:0;text-align:center;"><!--if mso | IEtable(role='presentation' border='0' cellpadding='0' cellspacing='0')
              tr
                td.invitation-title-container-outlook(style='vertical-align:top;width:600px;')--><div class="mj-column-per-100 mj-outlook-group-fix invitation-title-container" style="background: #deffe1; border-radius: 4px; border: 1px solid #deffe1; font-size: 0px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%"><tbody><tr><td style="vertical-align:top;padding-top:4px;padding-bottom:4px;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%"><tbody><tr><td align="left" style="font-size:0px;padding:0;padding-top:8px;padding-right:20px;padding-bottom:8px;padding-left:20px;word-break:break-word;"><div style="font-family:Roboto;font-size:16px;line-height:1;text-align:left;color:#222222;"><span style="font-weight: 500;">Alice</span><span>&nbsp;has cancelled the meeting.</span></div></td></tr></tbody></table></td></tr></tbody></table></div><!--if mso | IEtd.content-outlook(style='vertical-align:top;width:600px;')--><div class="mj-column-per-100 mj-outlook-group-fix content" style="border: 1px solid #ccc; border-radius: 4px; margin-top: 24px; font-size: 0px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%"><tbody><tr><td align="left" style="font-size:0px;padding:20px;word-break:break-word;"><div style="font-family:Roboto;font-size:20px;font-weight:500;line-height:1;text-align:left;color:#434343;">Cancelled Meeting</div></td></tr><tr><td align="left" style="font-size:0px;padding:20px;padding-top:0px;word-break:break-word;"><table cellpadding="4px" cellspacing="0" width="100%" border="0" style="color:#434343;font-family:Roboto;font-size:14px;line-height:22px;table-layout:auto;width:100%;border:none;"><tr><td valign="top" style="min-width: 80px;"><strong>Time</strong></td><td><span style="display: inline-block;">2025-07-04 09:00 - 10:00</span><span style="color: #787878; font-weight: 400; display: inline-block;">&nbsp;UTC</span></td></tr><tr><td style="min-width: 96px;" valign="top"><strong>Location</strong></td><td>Conference Room (<a href="https://www.openstreetmap.org/search?query=Conference Room">See in Map</a>)</td></tr><tr><td valign="top"><strong>Attendees</strong></td><td><ul style="padding-inline-start: 16px; margin: 0;"><li><span style="font-weight: 500">Alice</span><span style="color: #787878;">&nbsp;&lt;alice@domain.tld&gt;</span><span style="font-weight: 500">&nbsp;(Organizer)</span></li><li><span style="font-weight: 500">Bob Attendee</span><span style="color: #787878;">&nbsp;&lt;bob@domain.tld&gt;</span></li><li><span style="font-weight: 500">Carol Attendee</span><span style="color: #787878;">&nbsp;&lt;carol@domain.tld&gt;</span></li></ul></td></tr></table></td></tr></tbody></table></div><!--if mso | IE--></td></tr></tbody></table></div><!--if mso | IE--></td></tr></tbody></table></div><!--if mso | IEtable(align='center' border='0' cellpadding='0' cellspacing='0' style='width:600px;' width='600')
              tr
                td(style='line-height:0px;font-size:0px;mso-line-height-rule:exactly;')--><div style="margin:0px auto;max-width:600px;"><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;"><tbody><tr><td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;"><!--if mso | IEtable(role='presentation' border='0' cellpadding='0' cellspacing='0')
              tr
                td(width='600px')
