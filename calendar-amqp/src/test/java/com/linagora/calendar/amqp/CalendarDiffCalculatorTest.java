...
class CalendarDiffCalculatorTest {
    ...
    class RecurringRequestUpdate {
        ...
        @Test
        void invalidRecurrenceIdShouldNotFail() {
            // RRULE is weekly on Tuesday. DTSTART is set to a Tuesday (2035-09-25),
            String oldIcs = """
                BEGIN:VCALENDAR
                VERSION:2.0
                PRODID:-//Test//Test//EN
                METHOD:REQUEST
                BEGIN:VEVENT
                UID:uid-recur-invalid@test
                DTSTART;TZID=Europe/Paris:20350925T090000
                DTEND;TZID=Europe/Paris:20350925T100000
            ...
            // The override RECURRENCE-ID is intentionally set to Wednesday (2035-09-26),
            // which is NOT generated by RRULE:FREQ=WEEKLY;BYDAY=TU.
            String newIcs = """
                BEGIN:VCALENDAR
                VERSION:2.0
                PRODID:-//Test//Test//EN
                ...
                BEGIN:VEVENT
                UID:uid-recur-invalid@test
                RECURRENCE-ID;TZID=Europe/Paris:20350926T090000
                DTSTART;TZID=Europe/Paris:20350926T110000
                DTEND;TZID=Europe/Paris:20350926T120000
                SUMMARY:Weekly sync moved
                ATTENDEE:mailto:bob@example.com
                ORGANIZER:mailto:alice@example.com
                END:VEVENT
