...
public class DomainMembersSyncRouteModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(DavDomainMembersClearService.class).in(Scopes.SINGLETON);
    }
    ...
    @Named(DTOModuleInjections.WEBADMIN_DTO)
    @ProvidesIntoSet
    public AdditionalInformationDTOModule<? extends TaskExecutionDetails.AdditionalInformation, ? extends AdditionalInformationDTO> domainMembersClearTaskAdditionalInformation() {
        return DomainMembersClearTaskAdditionalInformationDTO.module();
    }
