...
public class DomainAdminRoutes implements Routes {
    ...
    private List<String> listDomainAdmins(Request request, Response response) {
        OpenPaaSDomain openPaaSDomain = checkValidDomain(request.params(DOMAIN_PARAM));
    ...
    private String addDomainAdmin(Request request, Response response) {
        OpenPaaSDomain openPaaSDomain = checkValidDomain(request.params(DOMAIN_PARAM));
        OpenPaaSUser userAdmin = checkValidAdminUser(request.params(USER_PARAM));
    ...
    private OpenPaaSUser checkValidAdminUser(String username) {
    ...
    private OpenPaaSDomain checkValidDomain(String domainName) {
        try {
