...
import static com.linagora.calendar.webadmin.CalendarUserRoutes.USER_TASKS;
...
public class LdapUsersImportRouteModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        userTaskRegistrationMultibinder.addBinding().to(CalendarUserRoutes.LdapUsersImportRequestToTask.class);
    }
