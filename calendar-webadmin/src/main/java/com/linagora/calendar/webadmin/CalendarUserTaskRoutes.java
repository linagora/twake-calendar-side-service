...
public class CalendarUserTaskRoutes implements Routes {
    public static class LdapUsersImportRequestToTask extends TaskFromRequestRegistry.TaskRegistration {
        ...
        public LdapUsersImportRequestToTask(LdapUsersImportService importService) {
            super(TASK_NAME, request -> {
                ...
                return new LdapUsersImportTask(importService, LdapUsersImportRunningOptions.of(usersPerSecond));
            });
        }
    ...
    public static final String BASE_PATH = "/registeredUsers/tasks";
    ...
    @Inject
    public CalendarUserTaskRoutes(JsonTransformer jsonTransformer, TaskManager taskManager,
