...
public record EventArchivalCriteria(Optional<Instant> createdBefore,
    ...
    public CalendarQuery toCalendarQuery() {
        ...
        declinedBy
            .ifPresent(username -> filters.add(AttendeePropFilter.declined(username)));
    ...
    public static final class Builder {
        ...
        private Optional<Username> declinedBy = Optional.empty();
        ...
        public EventArchivalCriteria.Builder declinedBy(Username username) {
            this.declinedBy = Optional.of(username);
            return this;
        }

        public EventArchivalCriteria build() {
            return new EventArchivalCriteria(createdBefore, lastModifiedBefore, masterDtStartBefore, declinedBy);
        }
    }
