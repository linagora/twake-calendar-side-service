...
class CalendarChannelLogoutRoutesTest {
    ...
    void setUp() {
        ...
        webAdminServer = WebAdminUtils.createWebAdminServer(new CalendarChannelLogoutRoutes(oidcTokenCache, new JsonTransformer())).start();

        RestAssured.requestSpecification = WebAdminUtils.buildRequestSpecification(webAdminServer)
            .setBasePath(CalendarChannelLogoutRoutes.BASE_PATH)
            .build();
    }
